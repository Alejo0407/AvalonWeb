 ...
 * @author AMD
 */
public class SE_SQL_bdcontabilidad extends SQL_Conexion {

    public SE_SQL_bdcontabilidad() {
        System.out.println("BDCONTABILIDAD");
        super.SQL_ConexionGeneral("bdcontabilidad");
    }

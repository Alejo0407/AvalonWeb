 ...
 * @author AMD
 */
public class SE_SQL_bdlogistica extends SQL_Conexion {

    public SE_SQL_bdlogistica() {
        System.out.println("BDLOGISTICA");
        super.SQL_ConexionGeneral("bdlogistica");
    }
    ...
    public ResultSet listAll(String nameEntidad) {
        ...
        try {
            ...
            Logger.getLogger(SE_SQL_bdlogistica.class.getName()).log(Level.SEVERE, null, ex);
        }
        return rs;
    }

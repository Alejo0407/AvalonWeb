 ...
 * @author AMD
 */
public class SE_SQL_bdplanificacion extends SQL_Conexion {

    public SE_SQL_bdplanificacion() {
        System.out.println("BDPLANIFICACION");
        super.SQL_ConexionGeneral("bdplanificacion");
    }
    ...
    public ResultSet listAll(String nameEntidad) {
        ...
        try {
            ...
            Logger.getLogger(SE_SQL_bdplanificacion.class.getName()).log(Level.SEVERE, null, ex);
        }
        return rs;
    }
